...
var require_engine = __commonJS({
  "build/obj/engine.js"(exports, module) {
    ...
    var engine3 = () => {
      ...
      var h = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), jr = (e, t) => {
        for (var u in t)
...
`;
      ...
      var we = h((is, Ut) => {
        ...
        Ut.exports = { Node: ae, TerminalNode: He, NonterminalNode: We, IterationNode: $e };
      });
      var zt = h((ss, Vt) => {
      ...
      var I = h((F) => {
        ...
        }, zr = Object.create(y.prototype), Kr = Object.create(y.prototype), Je = class extends y {
          constructor(t) {
            super(), this.obj = t;
          }
        }, Ze = class extends y {
      ...
      var $ = h((ps, Wt) => {
        ...
        function mn(e) {
          let t = e._node;
          Wr(t && t.isNonterminal() && t.ctorName === "escapeChar_unicodeCodePoint");
...
`, D + 1);
      ...
      var Jt = h(() => {
        ...
        x.PExpr.prototype._assertAllApplicationsAreValid = vn("_assertAllApplicationsAreValid");
      ...
      var Dt = h((Fs, uu) => {
        ...
        z.prototype.SKIP = {};
        Object.defineProperty(z.prototype, "displayString", { get() {
          return this.expr.toDisplayString();
        } });
        Object.keys(lt).forEach((e) => {
          let t = lt[e];
          Object.defineProperty(z.prototype, e, { get() {
        ...
        z.prototype.cloneWithExpr = function(e) {
          let t = new z(this.input, this.pos, this.pos2, e, this.succeeded, this.bindings, this.children);
        ...
        z.prototype.recordLRTermination = function(e, t) {
          this.terminatingLREntry = new z(this.input, this.pos, this.pos2, this.expr, false, [t], [e]), this.terminatingLREntry.terminatesLR = true;
        };
        z.prototype.walk = function(e, t) {
          let u = e;
...
`);
      ...
      var su = h(() => {
        ...
        B.PExpr.prototype.outputRecipe = Kn.abstract("outputRecipe");
        B.any.outputRecipe = function(e, t) {
          return ["any", K(this, t)];
        };
        B.end.outputRecipe = function(e, t) {
          return ["end", K(this, t)];
        };
        B.Terminal.prototype.outputRecipe = function(e, t) {
          return ["terminal", K(this, t), this.obj];
        };
        B.Range.prototype.outputRecipe = function(e, t) {
          return ["range", K(this, t), this.from, this.to];
        };
        B.Param.prototype.outputRecipe = function(e, t) {
          return ["param", K(this, t), this.index];
        };
        B.Alt.prototype.outputRecipe = function(e, t) {
          return ["alt", K(this, t)].concat(this.terms.map((u) => u.outputRecipe(e, t)));
        };
        B.Extend.prototype.outputRecipe = function(e, t) {
          return this.terms[0].outputRecipe(e, t);
        };
        B.Splice.prototype.outputRecipe = function(e, t) {
          let u = this.terms.slice(0, this.expansionPos), r = this.terms.slice(this.expansionPos + 1);
          return ["splice", K(this, t), u.map((n) => n.outputRecipe(e, t)), r.map((n) => n.outputRecipe(e, t))];
        };
        B.Seq.prototype.outputRecipe = function(e, t) {
          return ["seq", K(this, t)].concat(this.factors.map((u) => u.outputRecipe(e, t)));
        };
        B.Star.prototype.outputRecipe = B.Plus.prototype.outputRecipe = B.Opt.prototype.outputRecipe = B.Not.prototype.outputRecipe = B.Lookahead.prototype.outputRecipe = B.Lex.prototype.outputRecipe = function(e, t) {
          return [this.constructor.name.toLowerCase(), K(this, t), this.expr.outputRecipe(e, t)];
        };
        B.Apply.prototype.outputRecipe = function(e, t) {
          return ["app", K(this, t), this.ruleName, this.args.map((u) => u.outputRecipe(e, t))];
        };
        B.UnicodeChar.prototype.outputRecipe = function(e, t) {
          return ["unicodeChar", K(this, t), this.category];
        };
      });
      var ou = h(() => {
        "use strict";
      ...
      var au = h(() => {
        ...
        S.PExpr.prototype._isNullable = Wn.abstract("_isNullable");
...
`), u;
        ...
        w.prototype.addOperationOrAttribute = function(e, t, u) {
          ...
          function a(...o) {
            ...
            for (let [v, ue] of Object.entries(o)) {
              let me = p.formals[v];
              A[me] = ue;
            }
            let E = this.args;
...
`], ["app", { sourceInterval: [2439, 2442] }, "end", []]]]]], comment_multiLine: ["define", { sourceInterval: [2465, 2501] }, null, [], ["seq", { sourceInterval: [2465, 2487] }, ["terminal", { sourceInterval: [2465, 2469] }, "/*"], ["star", { sourceInterval: [2470, 2482] }, ["seq", { sourceInterval: [2471, 2480] }, ["not", { sourceInterval: [2471, 2476] }, ["terminal", { sourceInterval: [2472, 2476] }, "*/"]], ["app", { sourceInterval: [2477, 2480] }, "any", []]]], ["terminal", { sourceInterval: [2483, 2487] }, "*/"]]], comment: ["define", { sourceInterval: [2398, 2501] }, null, [], ["alt", { sourceInterval: [2412, 2501] }, ["app", { sourceInterval: [2412, 2443] }, "comment_singleLine", []], ["app", { sourceInterval: [2465, 2487] }, "comment_multiLine", []]]], tokens: ["define", { sourceInterval: [2505, 2520] }, null, [], ["star", { sourceInterval: [2514, 2520] }, ["app", { sourceInterval: [2514, 2519] }, "token", []]]], token: ["define", { sourceInterval: [2524, 2600] }, null, [], ["alt", { sourceInterval: [2532, 2600] }, ["app", { sourceInterval: [2532, 2540] }, "caseName", []], ["app", { sourceInterval: [2543, 2550] }, "comment", []], ["app", { sourceInterval: [2553, 2558] }, "ident", []], ["app", { sourceInterval: [2561, 2569] }, "operator", []], ["app", { sourceInterval: [2572, 2583] }, "punctuation", []], ["app", { sourceInterval: [2586, 2594] }, "terminal", []], ["app", { sourceInterval: [2597, 2600] }, "any", []]]], operator: ["define", { sourceInterval: [2604, 2669] }, null, [], ["alt", { sourceInterval: [2615, 2669] }, ["terminal", { sourceInterval: [2615, 2619] }, "<:"], ["terminal", { sourceInterval: [2622, 2625] }, "="], ["terminal", { sourceInterval: [2628, 2632] }, ":="], ["terminal", { sourceInterval: [2635, 2639] }, "+="], ["terminal", { sourceInterval: [2642, 2645] }, "*"], ["terminal", { sourceInterval: [2648, 2651] }, "+"], ["terminal", { sourceInterval: [2654, 2657] }, "?"], ["terminal", { sourceInterval: [2660, 2663] }, "~"], ["terminal", { sourceInterval: [2666, 2669] }, "&"]]], punctuation: ["define", { sourceInterval: [2673, 2709] }, null, [], ["alt", { sourceInterval: [2687, 2709] }, ["terminal", { sourceInterval: [2687, 2690] }, "<"], ["terminal", { sourceInterval: [2693, 2696] }, ">"], ["terminal", { sourceInterval: [2699, 2702] }, ","], ["terminal", { sourceInterval: [2705, 2709] }, "--"]]] }]);
      ...
      var Dr = h((po, ke) => {
        ...
        function _t(e, t, u) {
          ...
          return (u || Te).createSemantics().addOperation("visit", { Grammars(a) {
            ...
            let v = n.build();
            if (v.source = this.source.trimmed(), _ in t)
              throw ve.duplicateGrammarDeclaration(v, t);
            return t[_] = v, v;
          }, SuperGrammar(a, o) {
            let p = o.visit();
            if (p === "null")
            ...
            try {
              ...
              throw o instanceof RangeError && o.message.startsWith("Invalid code point ") ? ve.invalidCodePoint(a) : o;
            }
      ...
      var wt = h((ho, Fr) => {
        ...
        Fr.exports = { helper: zi, semantics: Ki };
      });
      var yr = h((Ao, gr) => {
        "use strict";
...
\r
    ...
    PriExp \r
        ...
        | ComparisonExp\r
\r
    ComparisonExp = EqualityExpr | LessThanExpr | MoreThanExpr | LessThanOrEqualExpr | MoreThanOrEqualExpr | NonEqualityExpr | exactElement\r
\r
