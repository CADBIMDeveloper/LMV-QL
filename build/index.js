...
var require_engine = __commonJS({
  "build/obj/engine.js"(exports, module) {
    var engine2 = () => {
      ...
      var Tr = Object.getPrototypeOf, kr = Object.prototype.hasOwnProperty;
      var A = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), jr = (e, t) => {
        for (var u in t)
          _e(e, u, { get: t[u], enumerable: true });
      }, kt = (e, t, u, r) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let n of Rr(t))
            !kr.call(e, n) && n !== u && _e(e, n, { get: () => t[n], enumerable: !(r = Lr(t, n)) || r.enumerable });
        return e;
      };
      var jt = (e, t, u) => (u = e != null ? qr(Tr(e)) : {}, kt(t || !e || !e.__esModule ? _e(u, "default", { value: e, enumerable: true }) : u, e)), Mr = (e) => kt(_e({}, "__esModule", { value: true }), e);
      var We = A((rs, Mt) => {
        "use strict";
        function Gr(e) {
...
`.charCodeAt(0)] = "\\n";
        ...
        var ze = (e) => String.fromCodePoint(parseInt(e, 16));
...
`;
              ...
              case "v":
                return "\v";
              case "x":
                return ze(e.slice(2, 4));
              case "u":
                return e.charAt(2) === "{" ? ze(e.slice(3, -1)) : ze(e.slice(2, 6));
              default:
                return e.charAt(1);
            }
          else
      ...
      var we = A((is, Ut) => {
        ...
        var Gt = m(), ae = class {
          ...
          isLexical() {
            return Gt.isLexical(this.ctorName);
          }
          isSyntactic() {
            return Gt.isSyntactic(this.ctorName);
          }
        }, $e = class extends ae {
          constructor(t, u, r, n) {
      ...
      var I = A((F) => {
        ...
        }, Wr = Object.create(y.prototype), zr = Object.create(y.prototype), Je = class extends y {
          constructor(t) {
            super(), this.obj = t;
          }
        }, Ze = class extends y {
        ...
        le.prototype.operator = "*";
        pe.prototype.operator = "+";
        De.prototype.operator = "?";
        le.prototype.minNumMatches = 0;
        pe.prototype.minNumMatches = 1;
        De.prototype.minNumMatches = 0;
        le.prototype.maxNumMatches = Number.POSITIVE_INFINITY;
        pe.prototype.maxNumMatches = Number.POSITIVE_INFINITY;
        De.prototype.maxNumMatches = 1;
        var tt = class extends y {
          ...
          isSyntactic() {
            return Vr.isSyntactic(this.ruleName);
          }
          toMemoKey() {
      ...
      var zt = A(() => {
        "use strict";
        var Kr = m(), T = I();
        T.PExpr.prototype.allowsSkippingPrecedingSpace = Kr.abstract("allowsSkippingPrecedingSpace");
      ...
      var $ = A((ps, Ht) => {
        ...
        function Yr(e, t, u) {
          let r = t ? "Grammar " + e + " is not declared in namespace " + $r.toString(t) : "Undeclared grammar " + e;
          return d(r, u);
        }
        function Xr(e, t) {
        ...
        var cn = "NOTE: A _syntactic rule_ is a rule whose name begins with a capital letter. See https://ohmjs.org/d/svl for more details.";
        function ln(e, t) {
          return d("Cannot apply syntactic rule " + e + " from here (inside a lexical context)", t.source);
        }
        function pn(e) {
          let { ruleName: t } = e;
          return d(`applySyntactic is for syntactic rules, but '${t}' is a lexical rule. ` + cn, e.source);
        }
        function Dn(e) {
        ...
        function mn(e) {
          let t = e._node;
          Hr(t && t.isNonterminal() && t.ctorName === "escapeChar_unicodeCodePoint");
...
`);
          let i = yn([t.prevLine == null ? 0 : t.lineNum - 1, t.lineNum, t.nextLine == null ? 0 : t.lineNum + 1]), s = (a, o, p) => {
            n.append(p + i[a] + " | " + o + `
`);
          };
          ...
          for (let a = 0; a < e.length; ++a) {
            ...
            let h = u - t.colNum + 1;
            o = Math.max(0, o - h), p = Math.min(p - h, l), c = $t(c, r("~", p - o), o);
          }
...
`), t.nextLine != null && s(2, t.nextLine, "  "), n.contents();
        ...
        var ot = [];
        re.awaitBuiltInRules = (e) => {
          ot.push(e);
        };
        re.announceBuiltInRules = (e) => {
          ot.forEach((t) => {
            t(e);
          }), ot = null;
        };
...
`, D + 1);
          ...
          return { offset: t, lineNum: u, colNum: r, line: a, prevLine: l, nextLine: s, toString: vn };
        };
      ...
      var Jt = A(() => {
        "use strict";
        var { abstract: Bn, isSyntactic: at } = m(), Q = $(), x = I(), In = Z(), Ee;
        ...
        x.PExpr.prototype._assertAllApplicationsAreValid = Bn("_assertAllApplicationsAreValid");
        ...
        x.Apply.prototype._assertAllApplicationsAreValid = function(e, t, u = false) {
          let r = t.rules[this.ruleName], n = at(e) && Oe === 0;
          if (!r)
            throw Q.undeclaredRule(this.ruleName, t.name, this.source);
          if (!u && at(this.ruleName) && !n)
      ...
      var Qt = A(() => {
        "use strict";
        var xn = m(), Zt = $(), O = I();
        O.PExpr.prototype.assertChoicesHaveUniformArity = xn.abstract("assertChoicesHaveUniformArity");
      ...
      var Yt = A(() => {
        "use strict";
        var Sn = m(), bn = $(), N = I();
        N.PExpr.prototype.assertIteratedExprsAreNotNullable = Sn.abstract("assertIteratedExprsAreNotNullable");
        ...
        N.Iter.prototype.assertIteratedExprsAreNotNullable = function(e) {
          if (this.expr.assertIteratedExprsAreNotNullable(e), this.expr.isNullable(e))
            throw bn.kleeneExprHasNullableOperand(this, []);
        };
      ...
      var Ne = A((Cs, eu) => {
        ...
        q.coverage = function(e, ...t) {
          ...
          for (let n of t) {
            if (n.sourceString !== e.sourceString)
              throw ct.intervalSourcesDontMatch();
        ...
        q.prototype = { coverageWith(...e) {
          ...
          return Xt.getLineAndColumn(this.sourceString, this.startIdx);
        }, getLineAndColumnMessage() {
          let e = [this.startIdx, this.endIdx];
          return Xt.getLineAndColumnMessage(this.sourceString, this.startIdx, e);
        }, minus(e) {
          ...
          if (this.sourceString !== e.sourceString)
            throw ct.intervalSourcesDontMatch();
          return _n(this.startIdx >= e.startIdx && this.endIdx <= e.endIdx, "other interval does not cover this one"), new q(this.sourceString, this.startIdx - e.startIdx, this.endIdx - e.startIdx);
        }, trimmed() {
      ...
      var Dt = A((Fs, uu) => {
        "use strict";
        var wn = Ne(), pt = m(), Pn = "\u2717", On = "\u2713", Nn = "\u22C5", qn = "\u21D2", Ln = "\u2409", Rn = "\u240A", Tn = "\u240D", lt = { succeeded: 1 << 0, isRootNode: 1 << 1, isImplicitSpaces: 1 << 2, isMemoized: 1 << 3, isHeadOfLeftRecursion: 1 << 4, terminatesLR: 1 << 5 };
        function kn(e) {
          return pt.repeat(" ", e).join("");
        }
        function jn(e, t, u) {
          let r = tu(e.slice(t, t + u));
          return r.length < u ? r + pt.repeat(" ", u - r.length).join("") : r;
        }
        function tu(e) {
          return typeof e == "string" ? e.replace(/ /g, Nn).replace(/\t/g, Ln).replace(/\n/g, Rn).replace(/\r/g, Tn) : String(e);
        }
        function W(e, t, u, r, n, i, s) {
          this.input = e, this.pos = this.pos1 = t, this.pos2 = u, this.source = new wn(e, t, u), this.expr = r, this.bindings = i, this.children = s || [], this.terminatingLREntry = null, this._flags = n ? lt.succeeded : 0;
        }
        W.prototype.SKIP = {};
        ...
        W.prototype.toString = function() {
          let e = new pt.StringBuffer();
          return this.walk((t, u, r) => {
            if (!t)
              return this.SKIP;
            if (t.expr.constructor.name !== "Alt") {
              if (e.append(jn(t.input, t.pos, 10) + kn(r * 2 + 1)), e.append((t.succeeded ? On : Pn) + " " + t.displayString), t.isHeadOfLeftRecursion && e.append(" (LR)"), t.succeeded) {
                let i = tu(t.source.contents);
                e.append(" " + qn + "  "), e.append(typeof i == "string" ? '"' + i + '"' : i);
              }
              e.append(`
`);
            }
      ...
      var nu = A(() => {
        "use strict";
        var Mn = Dt(), ru = m(), Gn = $(), ht = we(), g = I(), { TerminalNode: de } = ht, { NonterminalNode: Un } = ht, { IterationNode: Vn } = ht;
        g.PExpr.prototype.eval = ru.abstract("eval");
        ...
        g.Iter.prototype.eval = function(e) {
          ...
          for (; s < this.maxNumMatches && e.eval(this.expr); ) {
            ...
            l = t.pos, s++;
            let p = e._bindings.splice(e._bindings.length - r, r), h = e._bindingOffsets.splice(e._bindingOffsets.length - r, r);
            for (c = 0; c < p.length; c++)
              n[c].push(p[c]), i[c].push(h[c]);
          }
          if (s < this.minNumMatches)
            return false;
          let D = e.posToOffset(u), a = 0;
          if (s > 0) {
            let p = n[r - 1], h = i[r - 1], f = h[h.length - 1] + p[p.length - 1].matchLength;
            D = i[0][0], a = f - D;
          }
        ...
        g.Apply.prototype.reallyEval = function(e) {
          ...
          let h = !!c;
          if (s && (e.popFailuresInfo(), h || e.processFailure(u, this), p && (p.failuresAtRightmostPosition = e.cloneRecordedFailures())), e.isTracing() && p) {
            let f = e.getTraceEntry(u, this, h, h ? [c] : []);
            o && (ru.assert(f.terminatingLREntry != null || !h), f.isHeadOfLeftRecursion = true), p.traceEntry = f;
          }
          return t.examinedLength = Math.max(t.examinedLength, l), e.exitApplication(r, c), h;
        };
        ...
        g.Apply.prototype.growSeedResult = function(e, t, u, r, n) {
          ...
          for (; ; ) {
            if (r.matchLength = i.pos - u, r.value = n, r.failuresAtRightmostPosition = t.cloneRecordedFailures(), t.isTracing()) {
              ...
              r.traceEntry = new Mn(t.input, u, i.pos, this, true, [n], [s.clone()]);
            }
      ...
      var iu = A(() => {
        "use strict";
        var Wn = m(), k = I();
        k.PExpr.prototype.getArity = Wn.abstract("getArity");
      ...
      var su = A(() => {
        ...
        v.PExpr.prototype.outputRecipe = zn.abstract("outputRecipe");
      ...
      var ou = A(() => {
        "use strict";
        var Kn = m(), L = I();
        L.PExpr.prototype.introduceParams = Kn.abstract("introduceParams");
      ...
      var au = A(() => {
        ...
        S.PExpr.prototype._isNullable = Hn.abstract("_isNullable");
      ...
      var cu = A(() => {
        "use strict";
        var $n = m(), b = I();
        b.PExpr.prototype.substituteParams = $n.abstract("substituteParams");
      ...
      var Du = A(() => {
        "use strict";
        var pu = m(), R = I(), { copyWithoutDuplicates: Jn } = pu;
        function lu(e) {
        ...
        R.PExpr.prototype.toArgumentNameList = pu.abstract("toArgumentNameList");
      ...
      var hu = A(() => {
        "use strict";
        var Zn = m(), j = I();
        j.PExpr.prototype.toDisplayString = Zn.abstract("toDisplayString");
      ...
      var Au = A(() => {
        "use strict";
        var J = We(), Qn = m(), U = I();
        U.PExpr.prototype.toFailure = Qn.abstract("toFailure");
        U.any.toFailure = function(e) {
          return new J(this, "any object", "description");
        };
        U.end.toFailure = function(e) {
          return new J(this, "end of input", "description");
        };
        U.Terminal.prototype.toFailure = function(e) {
          return new J(this, this.obj, "string");
        };
        U.Range.prototype.toFailure = function(e) {
          return new J(this, JSON.stringify(this.from) + ".." + JSON.stringify(this.to), "code");
        };
        U.Not.prototype.toFailure = function(e) {
          let t = this.expr === U.any ? "nothing" : "not " + this.expr.toFailure(e);
          return new J(this, t, "description");
        };
        U.Lookahead.prototype.toFailure = function(e) {
          return this.expr.toFailure(e);
        };
        U.Apply.prototype.toFailure = function(e) {
      ...
      var mu = A(() => {
        "use strict";
        var Yn = m(), M = I();
        M.PExpr.prototype.toString = Yn.abstract("toString");
      ...
      var du = A((Us, Eu) => {
        "use strict";
        var Xn = We(), { TerminalNode: ei } = we(), { assert: ti } = m(), { PExpr: ui, Terminal: ri } = Y(), Ce = class extends ui {
          constructor(t) {
            super(), this.obj = t;
          }
          _getString(t) {
            let u = t.currentApplication().args[this.obj.index];
            return ti(u instanceof ri, "expected a Terminal expression"), u.obj;
          }
          ...
          eval(t) {
            ...
            return u.matchString(n, true) ? (t.pushBinding(new ei(n.length), r), true) : (t.processFailure(r, this), false);
          }
          getArity() {
            return 1;
          }
          ...
          toFailure(t) {
            return new Xn(this, this.obj.toFailure(t) + " (case-insensitive)", "description");
          }
          _isNullable(t, u) {
      ...
      var qe = A((Vs, Fu) => {
        ...
        Cu.prototype = { atEnd() {
          ...
          return new ni(this.source, e, t || this.pos);
        } };
        Fu.exports = Cu;
      });
      var ft = A((Ws, yu) => {
        ...
        X.prototype.getExpectedText = function() {
          ...
          let e = new mt.StringBuffer(), t = this.getRightmostFailures();
      ...
      var _u = A((Ks, bu) => {
        ...
        Su.prototype = { posToOffset(e) {
          ...
          return t || (t = this.memoTable[e] = new ai()), t;
        }, processFailure(e, t) {
          ...
          if (t instanceof dt.Apply) {
            let n = this.currentApplication(), i = n ? n.args : [];
            t = t.substituteParams(i);
          }
          return this.getMemoizedTraceEntry(e, t) || new ci(this.input, e, this.inputStream.pos, t, u, r, this.trace);
        }, isTracing() {
          return !!this.trace;
        }, hasNecessaryInfo(e) {
          ...
          return t && (t.grammar = this.grammar), new oi(this.matcher, this.input, this.startExpr, t, this._bindingOffsets[0], this.rightmostFailurePosition, e);
        }, getTrace() {
          this.trace = [];
      ...
      var gt = A(($s, Lu) => {
        ...
        var Di = qe(), { IterationNode: hi } = we(), Ai = ft(), Ct = m(), mi = $(), Nu = Z(), Fe = [], Ft = (e, t) => Object.prototype.hasOwnProperty.call(e, t), Le = class {
          ...
          iteration(t) {
            let u = t || [], r = u.map((s) => s._node), n = new hi(r, [], -1, false), i = this._semantics.wrap(n, null, null);
        ...
        function w(e, t) {
          ...
          if (this.grammar = e, this.checkedActionDicts = false, this.Wrapper = class extends (t ? t.Wrapper : Le) {
            ...
            for (let r in this.attributes)
              Object.defineProperty(this.attributeKeys, r, { value: Nu.uniqueId(r) });
          } else
...
`, u += "  return g.extendSemantics(semantics)";
    ...
    .` + a + "(" + JSON.stringify(D) + ", {";
              ...
              Object.keys(s).forEach((p) => {
                if (s[p] !== c) {
                  let h = s[p].toString().trim();
                  h = h.replace(/^.*\(/, "function("), o.push(`
      ` + JSON.stringify(p) + ": " + h);
                }
              }), u += o.join(",") + `
    })`;
...
`), u;
        ...
        function qu(e, t) {
          if (!w.prototypeGrammar)
            return Ct.assert(e.indexOf("(") === -1), { name: e, formals: [] };
        ...
        function fi(e, t, u) {
          return function(...r) {
            ...
            throw mi.missingSemanticAction(this.ctorName, t, e, Fe);
          };
        }
        w.prototype.addOperationOrAttribute = function(e, t, u) {
          ...
          function a(...o) {
            ...
            for (let [B, ue] of Object.entries(o)) {
              let me = p.formals[B];
              h[me] = ue;
            }
            let f = this.args;
          ...
          e === "operation" ? (this.Wrapper.prototype[i] = a, this.Wrapper.prototype[i].toString = function() {
            return "[" + i + " operation]";
          }) : (Object.defineProperty(this.Wrapper.prototype, i, { get: a, configurable: true }), Object.defineProperty(this.attributeKeys, i, { value: Nu.uniqueId(i) }));
        };
        w.prototype.extendOperationOrAttribute = function(e, t, u) {
          let r = e + "s";
          if (qu(t, "attribute"), !(this.super && t in this.super[r]))
        ...
        w.createSemantics = function(e, t) {
          let u = new w(e, t !== void 0 ? t : w.BuiltInSemantics._getSemantics()), r = function(i) {
            if (!(i instanceof Ai))
              throw new TypeError("Semantics expected a MatchResult, but got " + Ct.unexpectedObjToString(i));
            if (i.failed())
        ...
        ne.prototype.typeName = "operation";
        var ge = class extends ne {
          ...
          execute(t, u) {
            ...
            return Ft(r, n) || (r[n] = ne.prototype.execute.call(this, t, u)), r[n];
          }
        };
      ...
      var ye = A((Zs, Vu) => {
        "use strict";
        var Ei = du(), di = Ou(), Ru = gt(), Tu = m(), ku = $(), K = Y(), ju = ["_iter", "_terminal", "_nonterminal", "_default"];
        function Mu(e) {
          return Object.keys(e.rules).sort().map((t) => e.rules[t]);
        }
        var Ci = (e) => e.replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029");
        function ie(e, t, u, r) {
        ...
        var Gu, Uu;
        ie.initApplicationParser = function(e, t) {
          Gu = e, Uu = t;
        };
        ie.prototype = { matcher() {
          return new di(this);
        }, isBuiltIn() {
          return this === ie.ProtoBuiltInRules || this === ie.BuiltInRules;
        }, equals(e) {
          if (this === e)
            return true;
          ...
          return Ru.createSemantics(this);
        }, extendSemantics(e) {
          return Ru.createSemantics(this, e._getSemantics());
        }, _checkTopDownActionDict(e, t, u) {
          let r = [];
          for (let n in u) {
            let i = u[n];
            if (!ju.includes(n) && !(n in this.rules)) {
...
`));
          ...
          return ju.includes(e) ? 0 : this.rules[e].body.getArity();
        }, _inheritsFrom(e) {
          ...
          Object.keys(this.rules).forEach((s) => {
            ...
            let p = D ? l.description : null, h = c.outputRecipe(l.formals, this.source);
            r[s] = [a, o, p, l.formals, h];
          });
          let n = "null";
...
`), e.append("  "), this.addSemanticActionTemplate(u, r, e);
          ...
          u.append(Tu.repeat("_", r).join(", ")), u.append(`) {
`), u.append("  }");
        }, parseApplication(e) {
          let t;
          if (e.indexOf("<") === -1)
            ...
            let r = Gu.match(e, "Base_application");
            t = Uu(r, {});
          }
          if (!(t.ruleName in this.rules))
            throw ku.undeclaredRule(t.ruleName, this.name);
          let { formals: u } = this.rules[t.ruleName];
          if (u.length !== t.args.length) {
            let { source: r } = this.rules[t.ruleName];
            throw ku.wrongNumberOfParameters(t.ruleName, u.length, t.args.length, r);
          }
          return t;
        } };
        ie.ProtoBuiltInRules = new ie("ProtoBuiltInRules", void 0, { any: { body: K.any, formals: [], description: "any character", primitive: true }, end: { body: K.end, formals: [], description: "end of input", primitive: true }, caseInsensitive: { body: new Ei(new K.Param(0)), formals: ["str"], primitive: true }, lower: { body: new K.UnicodeChar("Ll"), formals: [], description: "a lowercase letter", primitive: true }, upper: { body: new K.UnicodeChar("Lu"), formals: [], description: "an uppercase letter", primitive: true }, unicodeLtmo: { body: new K.UnicodeChar("Ltmo"), formals: [], description: "a Unicode character in Lt, Lm, or Lo", primitive: true }, spaces: { body: new K.Star(new K.Apply("space")), formals: [] }, space: { body: new K.Range("\0", " "), formals: [], description: "a space" } });
        Vu.exports = ie;
      });
      var Ku = A((Qs, zu) => {
        "use strict";
        var yt = ye(), Fi = qe(), Wu = m(), te = $(), gi = Y();
        function V(e) {
          this.name = e;
        }
        V.prototype.sourceInterval = function(e, t) {
          return this.source.subInterval(e, t - e);
        };
        V.prototype.ensureSuperGrammar = function() {
          return this.superGrammar || this.withSuperGrammar(this.name === "BuiltInRules" ? yt.ProtoBuiltInRules : yt.BuiltInRules), this.superGrammar;
        };
        V.prototype.ensureSuperGrammarRuleForOverriding = function(e, t) {
          let u = this.ensureSuperGrammar().rules[e];
          if (!u)
            throw te.cannotOverrideUndeclaredRule(e, this.superGrammar.name, t);
          return u;
        };
        V.prototype.installOverriddenOrExtendedRule = function(e, t, u, r) {
          let n = Wu.getDuplicates(t);
          if (n.length > 0)
        ...
        V.prototype.withSuperGrammar = function(e) {
        ...
        V.prototype.withDefaultStartRule = function(e) {
          return this.defaultStartRule = e, this;
        };
        V.prototype.withSource = function(e) {
          return this.source = new Fi(e).interval(0, e.length), this;
        };
        V.prototype.build = function() {
          let e = new yt(this.name, this.ensureSuperGrammar(), this.rules, this.defaultStartRule), t = [], u = false;
        ...
        V.prototype.define = function(e, t, u, r, n) {
      ...
      var vt = A((Ys, Ju) => {
        ...
        $u.prototype = { currentDecl: null, currentRuleName: null, newGrammar(e) {
          ...
          return u && i.withSuperGrammar(u instanceof yi ? u : this.fromRecipe(u)), r && i.withDefaultStartRule(r), e && e.source && i.withSource(e.source), this.currentDecl = i, Object.keys(n).forEach((s) => {
            ...
            let l = n[s], c = l[0], D = l[1], a = l[2], o = l[3], p = this.fromRecipe(l[4]), h;
            i.source && D && D.sourceInterval && (h = i.source.subInterval(D.sourceInterval[0], D.sourceInterval[1] - D.sourceInterval[0])), i[c](s, o, p, a, h);
  ...
  applySyntactic<app> = app
      ...
      var ir = A((io, nr) => {
        var { makeRecipe: Si } = ve();
        nr.exports = Si(["grammar", { source: `OperationsAndAttributes {
  ...
  nameRest
    ...
    | alnum
      ...
      var cr = A((lo, ar) => {
        var { makeRecipe: Pi } = ve();
        ar.exports = Pi(["grammar", { source: `Ohm {
...
`], ["app", { sourceInterval: [2439, 2442] }, "end", []]]]]], comment_multiLine: ["define", { sourceInterval: [2465, 2501] }, null, [], ["seq", { sourceInterval: [2465, 2487] }, ["terminal", { sourceInterval: [2465, 2469] }, "/*"], ["star", { sourceInterval: [2470, 2482] }, ["seq", { sourceInterval: [2471, 2480] }, ["not", { sourceInterval: [2471, 2476] }, ["terminal", { sourceInterval: [2472, 2476] }, "*/"]], ["app", { sourceInterval: [2477, 2480] }, "any", []]]], ["terminal", { sourceInterval: [2483, 2487] }, "*/"]]], comment: ["define", { sourceInterval: [2398, 2501] }, null, [], ["alt", { sourceInterval: [2412, 2501] }, ["app", { sourceInterval: [2412, 2443] }, "comment_singleLine", []], ["app", { sourceInterval: [2465, 2487] }, "comment_multiLine", []]]], tokens: ["define", { sourceInterval: [2505, 2520] }, null, [], ["star", { sourceInterval: [2514, 2520] }, ["app", { sourceInterval: [2514, 2519] }, "token", []]]], token: ["define", { sourceInterval: [2524, 2600] }, null, [], ["alt", { sourceInterval: [2532, 2600] }, ["app", { sourceInterval: [2532, 2540] }, "caseName", []], ["app", { sourceInterval: [2543, 2550] }, "comment", []], ["app", { sourceInterval: [2553, 2558] }, "ident", []], ["app", { sourceInterval: [2561, 2569] }, "operator", []], ["app", { sourceInterval: [2572, 2583] }, "punctuation", []], ["app", { sourceInterval: [2586, 2594] }, "terminal", []], ["app", { sourceInterval: [2597, 2600] }, "any", []]]], operator: ["define", { sourceInterval: [2604, 2669] }, null, [], ["alt", { sourceInterval: [2615, 2669] }, ["terminal", { sourceInterval: [2615, 2619] }, "<:"], ["terminal", { sourceInterval: [2622, 2625] }, "="], ["terminal", { sourceInterval: [2628, 2632] }, ":="], ["terminal", { sourceInterval: [2635, 2639] }, "+="], ["terminal", { sourceInterval: [2642, 2645] }, "*"], ["terminal", { sourceInterval: [2648, 2651] }, "+"], ["terminal", { sourceInterval: [2654, 2657] }, "?"], ["terminal", { sourceInterval: [2660, 2663] }, "~"], ["terminal", { sourceInterval: [2666, 2669] }, "&"]]], punctuation: ["define", { sourceInterval: [2673, 2709] }, null, [], ["alt", { sourceInterval: [2687, 2709] }, ["terminal", { sourceInterval: [2687, 2690] }, "<"], ["terminal", { sourceInterval: [2693, 2696] }, ">"], ["terminal", { sourceInterval: [2699, 2702] }, ","], ["terminal", { sourceInterval: [2705, 2709] }, "--"]]] }]);
      ...
      var Dr = A((po, ke) => {
        "use strict";
        var Oi = vt(), xt = ye(), It = st(), lr = m(), Be = $(), St = Y(), bt = Z(), Ni = Yu(), { makeRecipe: qi } = ve(), Te, Bt = Object.create(St.PExpr.prototype), Li = (e) => !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
        function _t(e, t, u) {
          ...
          return (u || Te).createSemantics().addOperation("visit", { Grammars(a) {
            ...
            let _ = a.visit();
            n = r.newGrammar(_, t), o.child(0) && o.child(0).visit(), h.children.map((ue) => ue.visit());
            let B = n.build();
            ...
            let _ = f.visit(), B = p.children.map((me) => me.visit())[0], ue = this.source.trimmed();
            return n.define(i, s, _, B, ue);
          }, Rule_override(a, o, p, h) {
            ...
            i = a.visit(), s = o.children.map((B) => B.visit())[0] || [];
            let f = h.visit(), _ = this.source.trimmed();
            return n.extend(i, s, f, null, _);
          }, RuleBody(a, o) {
            return r.alt(...o.visit()).withSource(this.source);
          }, OverrideRuleBody(a, o) {
            let p = o.visit(), h = p.indexOf(Bt);
            if (h >= 0) {
              let f = p.slice(0, h), _ = p.slice(h + 1);
              return _.forEach((B) => {
                if (B === Bt)
            ...
            let p = i + "_" + o.visit(), h = a.visit(), f = this.source.trimmed(), _ = !(n.superGrammar && n.superGrammar.rules[p]);
            l && !_ ? n.override(p, s, h, null, f) : n.define(p, s, h, null, f);
            let B = s.map((ue) => r.app(ue));
            return r.app(p, B).withSource(h.source);
            ...
            let p = o.children.map((h) => h.visit())[0] || [];
        ...
        function Ti(e, t) {
          let u = pr(e, t), r = Object.keys(u);
          if (r.length === 0)
            throw new Error("Missing grammar definition");
          if (r.length > 1) {
            let i = u[r[1]].source;
            throw new Error(bt.getLineAndColumnMessage(i.sourceString, i.startIdx) + "Found more than one grammar definition -- use ohm.grammars() instead.");
          }
          return u[r[0]];
        }
        function pr(e, t) {
          let u = It.extend(It.asNamespace(t));
          if (typeof e != "string")
            if (Li(e))
              e = e.toString();
            else
              throw new TypeError("Expected string as first argument, got " + lr.unexpectedObjToString(e));
          return Ri(e, u), u;
        }
        function ki(e) {
        ...
        ke.exports = { createNamespace: It.createNamespace, grammar: Ti, grammars: pr, grammarFromScriptElement: ki, grammarsFromScriptElements: ji, makeRecipe: qi, ohmGrammar: null, pexprs: St, util: bt, version: Ni };
        ke.exports._buildGrammar = _t;
        or();
        bt.announceBuiltInRules(xt.BuiltInRules);
      ...
      var dr = A((Do, Er) => {
        ...
        function hr(e) {
          let t = e.split(/ ?\[\]/);
          return t.length === 2 ? Gi.bind(null, t[0]) : Mi.bind(null, e);
        }
        function Ar(e, t, u) {
          return e.map((r) => r(t, u));
        }
        function Ui(e) {
          return typeof e == "string" ? Ar.bind(null, [hr(e)]) : Array.isArray(e) ? Ar.bind(null, e.map(hr)) : (se(typeof e == "function", "Expected a string, Array, or function"), se(e.length === 2, "Expected a function of arity 2, got " + e.length), e);
        }
        function mr(e) {
          return /^[a-zA-Z_][0-9a-zA-Z_]*$/.test(e);
        }
        ...
        je.prototype._checkActionDict = function(e) {
          Object.keys(e).forEach((t) => {
            se(t in this._getChildren, "Unrecognized action name '" + t + "'");
            let u = e[t];
            if (se(typeof u == "function", "Key '" + t + "': expected function, got " + u), t in this._arities) {
              let r = this._arities[t], n = e[t].length;
              se(n === r, "Action '" + t + "' has the wrong arity: expected " + r + ", got " + n);
            }
          });
        };
      ...
      var wt = A((ho, Fr) => {
        ...
        function zi(e) {
          ...
          return e.createSemantics().addOperation("toAST(mapping)", Cr);
        }
        Fr.exports = { helper: Wi, semantics: zi };
      });
      var yr = A((Ao, gr) => {
        "use strict";
        gr.exports = { VisitorFamily: dr(), semanticsForToAST: wt().semantics, toAST: wt().helper };
      });
      var Ir = A((mo, Br) => {
        "use strict";
        var vr = Dr();
      ...
      var Pt = A((fo, xr) => {
        "use strict";
        var Ki = Ir(), Hi = Ki.makeRecipe(["grammar", { source: `Filter {\r
    Exp = BoolOr\r
    \r
    BoolOr\r
...
\r
    ...
    realNumber = digit* "." digit+\r
      ...
      var ts = {};
      jr(ts, { computeExpression: () => es, filterElements: () => Xi });
      var Rt = jt(Pt());
      var Ot = (e, t) => {
        if (e.length > t)
      ...
      var Ji = (e) => e.type === "number", Zi = (e) => typeof e == "number", Qi = (e) => typeof e == "string", he = (e, t) => (u, r, n) => {
        ...
        return Ji(s) ? (l, c) => xe(c.categoriesList, i.categories) ? Me(i.categories, c.categoriesList.length).map((a) => c.getPropertyValue(i.propertyName, a)).filter(Zi).reduce((a, o) => a || e(o, s.value, l), false) : false : (l, c) => {
          if (!xe(c.categoriesList, i.categories))
            return false;
          let D = Me(i.categories, c.categoriesList.length), a = l.stringCaseSensitive ? s.value : s.value.toLocaleLowerCase(), o = (p, h, f) => {
            for (; p.indexOf(h) >= 0; )
              p = p.replace(h, f);
            return p;
          };
          return D.map((p) => c.getPropertyValue(i.propertyName, p)).filter(Qi).map((p) => l.stringCaseSensitive ? p : p.toLocaleLowerCase()).reduce((p, h) => p || t(h, o(a, '\\"', '"')), false);
        };
      }, Pr = { exactElement: (e) => {
        let t = e.getPropertyDefinition();
        return (u, r) => xe(r.categoriesList, t.categories);
      }, EqualityExpr: he((e, t, u) => oe(e, t, u.tolerance), (e, t) => e === t), LessThanExpr: he((e, t, u) => Sr(e, t, u.tolerance), (e, t) => e < t), LessThanOrEqualExpr: he((e, t, u) => _r(e, t, u.tolerance), (e, t) => e <= t), MoreThanExpr: he((e, t, u) => br(e, t, u.tolerance), (e, t) => e > t), MoreThanOrEqualExpr: he((e, t, u) => wr(e, t, u.tolerance), (e, t) => e >= t), BoolAnd_and: (e, t, u) => (r, n) => e.compile()(r, n) && u.compile()(r, n), BoolOr_or: (e, t, u) => (r, n) => e.compile()(r, n) || u.compile()(r, n), PriExp_paren: (e, t, u) => (r, n) => t.compile()(r, n), NonEqualityExpr: he((e, t, u) => !oe(e, t, u.tolerance), (e, t) => e !== t) }, Nt = (e, t) => {
      ...
      }, Lt = (e) => ({ type: "simple", value: e.sourceString }), Ge = { exactElement_ofCategory: (e, t) => ({ type: "exact-category", categories: [e.getPropertyDefinition().value] }), categoryOrProperty_inBrackets: (e, t, u) => Lt(t), categoryOrProperty_value: (e) => Lt(e), exactElement_ofPropertySequence: (e, t) => qt(e), property_ofPropertySequence: (e, t, u) => Nt(e, u), property_ofDirectAny: (e, t, u) => Nt(e, u), property_ofDirectAnyPropertySequence: (e, t, u) => Nt(e, u), directAnyProperty_ofCategory: (e, t, u) => ({ type: "exact-category", categories: [e.getPropertyDefinition().value, "*"] }), directAnyPropertySequence: (e, t, u) => qt(e), directAnyProperty_sequenced: (e, t, u) => {
        let n = [...qt(e).categories];
        return n.push("*"), { type: "exact-category", categories: n };
      }, propertySequence: (e) => Or(e), directProperty_ofCategory: (e, t, u) => {
        let r = e.getPropertyDefinition(), n = u.getPropertyDefinition();
        return { type: "exact-category", categories: [r.value, n.value] };
      }, directProperty_ofAnyProperty: (e, t, u) => ({ type: "exact-category", categories: ["*", u.getPropertyDefinition().value] }), number: (e) => ({ type: "number", value: parseFloat(e.sourceString) }), textConst: (e, t, u) => t.getPropertyDefinition(), textValue: (e) => Lt(e) }, Nr = { propertySequence: (e) => {
        let t = Or(e);
      ...
      var Ue = class {
        semantics = Rt.default.createSemantics();
        constructor() {
          this.semantics.addOperation("getPropertyDefinition", Ge), this.semantics.addOperation("getPropertyValue", Nr);
        }
        createPropertyQuery(t) {
          let u = Rt.default.match(t, "propertySequence");
          if (u.failed())
      ...
      var Ve = class {
        ...
        settings;
        constructor(t) {
          this.settings = t || { tolerance: 1e-5, stringCaseSensitive: true }, this.semantics.addOperation("getPropertyDefinition", Ge), this.semantics.addOperation("compile", Pr);
        }
        createFilter(t) {
          let u = Tt.default.match(t);
          if (u.failed())
            throw new Ae(u.message, u.shortMessage);
      ...
      var be = class {
        ...
        categoryNodesDbIds;
        constructor(t, u, r) {
          this.dbId = t, this.propertyDatabase = u, this.attributes = r, this.categoryNodesDbIds = Yi(t, u);
        }
        get categoriesList() {
