...
`;
      ...
      var I = h((F) => {
        ...
        }, Wr = Object.create(y.prototype), zr = Object.create(y.prototype), Ze = class extends y {
          constructor(t) {
            super(), this.obj = t;
          }
        }, Qe = class extends y {
        ...
        var ut = class extends y {
          ...
          isSyntactic() {
            return Ur.isSyntactic(this.ruleName);
          }
          toMemoKey() {
          ...
          constructor(t) {
            super(), this.category = t, this.pattern = Vr[t];
          }
        };
        F.PExpr = y;
        F.any = Wr;
...
`, D + 1);
      ...
      var Jt = h(() => {
        "use strict";
        var { abstract: Bn, isSyntactic: ct } = m(), Q = $(), x = I(), In = Z(), Ee;
      ...
      var ht = h((Fs, uu) => {
        "use strict";
        var wn = Ne(), Dt = m(), Pn = "\u2717", On = "\u2713", Nn = "\u22C5", qn = "\u21D2", Ln = "\u2409", Rn = "\u240A", Tn = "\u240D", pt = { succeeded: 1 << 0, isRootNode: 1 << 1, isImplicitSpaces: 1 << 2, isMemoized: 1 << 3, isHeadOfLeftRecursion: 1 << 4, terminatesLR: 1 << 5 };
        function kn(e) {
        ...
        function W(e, t, u, r, n, i, s) {
          this.input = e, this.pos = this.pos1 = t, this.pos2 = u, this.source = new wn(e, t, u), this.expr = r, this.bindings = i, this.children = s || [], this.terminatingLREntry = null, this._flags = n ? pt.succeeded : 0;
        }
        W.prototype.SKIP = {};
...
`);
      ...
      var nu = h(() => {
        "use strict";
        var Mn = ht(), ru = m(), Gn = $(), At = we(), g = I(), { TerminalNode: de } = At, { NonterminalNode: Vn } = At, { IterationNode: Un } = At;
        ...
        g.Iter.prototype.eval = function(e) {
          ...
          for (c = 0; c < n.length; c++)
            e._bindings.push(new Un(n[c], i[c], a, o)), e._bindingOffsets.push(D);
          return true;
        };
        ...
        g.Apply.prototype.evalOnce = function(e, t) {
          ...
          if (t.eval(e)) {
            ...
            return new Vn(this.ruleName, i, s, l);
          } else
            return false;
        };
      ...
      var Au = h(() => {
        "use strict";
        var J = ze(), Qn = m(), V = I();
        V.PExpr.prototype.toFailure = Qn.abstract("toFailure");
      ...
      var _u = h((Ks, bu) => {
        "use strict";
        var si = qe(), oi = Et(), ai = Iu(), ci = ht(), Ct = Y(), li = Z(), xu;
      ...
      var yt = h(($s, Lu) => {
        "use strict";
        var Di = qe(), { IterationNode: hi } = we(), Ai = Et(), Ft = m(), mi = $(), Nu = Z(), Fe = [], gt = (e, t) => Object.prototype.hasOwnProperty.call(e, t), Le = class {
          constructor(t, u, r) {
...
`), u;
      ...
      var ye = h((Zs, Uu) => {
        "use strict";
        var Ei = du(), di = Ou(), Ru = yt(), Tu = m(), ku = $(), K = Y(), ju = ["_iter", "_terminal", "_nonterminal", "_default"];
        function Mu(e) {
...
`), u.append("  }");
        ...
        se.ProtoBuiltInRules = new se("ProtoBuiltInRules", void 0, { any: { body: K.any, formals: [], description: "any character", primitive: true }, end: { body: K.end, formals: [], description: "end of input", primitive: true }, caseInsensitive: { body: new Ei(new K.Param(0)), formals: ["str"], primitive: true }, lower: { body: new K.UnicodeChar("Ll"), formals: [], description: "a lowercase letter", primitive: true }, upper: { body: new K.UnicodeChar("Lu"), formals: [], description: "an uppercase letter", primitive: true }, unicodeLtmo: { body: new K.UnicodeChar("Ltmo"), formals: [], description: "a Unicode character in Lt, Lm, or Lo", primitive: true }, spaces: { body: new K.Star(new K.Apply("space")), formals: [] }, space: { body: new K.Range("\0", " "), formals: [], description: "a space" } });
        Uu.exports = se;
      });
      var Ku = h((Qs, zu) => {
        "use strict";
        var vt = ye(), Fi = qe(), Wu = m(), te = $(), gi = Y();
        function U(e) {
          this.name = e;
        }
...
`], ["app", { sourceInterval: [2439, 2442] }, "end", []]]]]], comment_multiLine: ["define", { sourceInterval: [2465, 2501] }, null, [], ["seq", { sourceInterval: [2465, 2487] }, ["terminal", { sourceInterval: [2465, 2469] }, "/*"], ["star", { sourceInterval: [2470, 2482] }, ["seq", { sourceInterval: [2471, 2480] }, ["not", { sourceInterval: [2471, 2476] }, ["terminal", { sourceInterval: [2472, 2476] }, "*/"]], ["app", { sourceInterval: [2477, 2480] }, "any", []]]], ["terminal", { sourceInterval: [2483, 2487] }, "*/"]]], comment: ["define", { sourceInterval: [2398, 2501] }, null, [], ["alt", { sourceInterval: [2412, 2501] }, ["app", { sourceInterval: [2412, 2443] }, "comment_singleLine", []], ["app", { sourceInterval: [2465, 2487] }, "comment_multiLine", []]]], tokens: ["define", { sourceInterval: [2505, 2520] }, null, [], ["star", { sourceInterval: [2514, 2520] }, ["app", { sourceInterval: [2514, 2519] }, "token", []]]], token: ["define", { sourceInterval: [2524, 2600] }, null, [], ["alt", { sourceInterval: [2532, 2600] }, ["app", { sourceInterval: [2532, 2540] }, "caseName", []], ["app", { sourceInterval: [2543, 2550] }, "comment", []], ["app", { sourceInterval: [2553, 2558] }, "ident", []], ["app", { sourceInterval: [2561, 2569] }, "operator", []], ["app", { sourceInterval: [2572, 2583] }, "punctuation", []], ["app", { sourceInterval: [2586, 2594] }, "terminal", []], ["app", { sourceInterval: [2597, 2600] }, "any", []]]], operator: ["define", { sourceInterval: [2604, 2669] }, null, [], ["alt", { sourceInterval: [2615, 2669] }, ["terminal", { sourceInterval: [2615, 2619] }, "<:"], ["terminal", { sourceInterval: [2622, 2625] }, "="], ["terminal", { sourceInterval: [2628, 2632] }, ":="], ["terminal", { sourceInterval: [2635, 2639] }, "+="], ["terminal", { sourceInterval: [2642, 2645] }, "*"], ["terminal", { sourceInterval: [2648, 2651] }, "+"], ["terminal", { sourceInterval: [2654, 2657] }, "?"], ["terminal", { sourceInterval: [2660, 2663] }, "~"], ["terminal", { sourceInterval: [2666, 2669] }, "&"]]], punctuation: ["define", { sourceInterval: [2673, 2709] }, null, [], ["alt", { sourceInterval: [2687, 2709] }, ["terminal", { sourceInterval: [2687, 2690] }, "<"], ["terminal", { sourceInterval: [2693, 2696] }, ">"], ["terminal", { sourceInterval: [2699, 2702] }, ","], ["terminal", { sourceInterval: [2705, 2709] }, "--"]]] }]);
      ...
      var Dr = h((po, ke) => {
        "use strict";
        var Oi = Bt(), St = ye(), xt = ot(), lr = m(), Be = $(), bt = Y(), _t = Z(), Ni = Yu(), { makeRecipe: qi } = ve(), Te, It = Object.create(bt.PExpr.prototype), Li = (e) => !!e.constructor && typeof e.constructor.isBuffer == "function" && e.constructor.isBuffer(e);
        function wt(e, t, u) {
        ...
        ke.exports = { createNamespace: xt.createNamespace, grammar: Ti, grammars: pr, grammarFromScriptElement: ki, grammarsFromScriptElements: ji, makeRecipe: qi, ohmGrammar: null, pexprs: bt, util: _t, version: Ni };
      ...
      var dr = h((Do, Er) => {
        ...
        function Vi(e) {
          return typeof e == "string" ? Ar.bind(null, [hr(e)]) : Array.isArray(e) ? Ar.bind(null, e.map(hr)) : (oe(typeof e == "function", "Expected a string, Array, or function"), oe(e.length === 2, "Expected a function of arity 2, got " + e.length), e);
        }
        function mr(e) {
          return /^[a-zA-Z_][0-9a-zA-Z_]*$/.test(e);
        }
        ...
        function je(e) {
          this._shapes = e.shapes, this._getTag = e.getTag, this.Adapter = function(t, u) {
            ...
            this._getChildren[t] = Vi(u), typeof u != "function" && (this._arities[t] = Array.isArray(u) ? u.length : 1);
      ...
      var yr = h((Ao, gr) => {
        "use strict";
        gr.exports = { VisitorFamily: dr(), semanticsForToAST: Pt().semantics, toAST: Pt().helper };
      });
      var Ir = h((mo, Br) => {
        "use strict";
        var vr = Dr();
...
\r
    ...
    realNumber = digit* "." digit+\r
      ...
      var ae = (e, t, u = 1e-5) => Math.abs(e - t) < u, Sr = (e, t, u = 1e-5) => e < t && !ae(e, t, u), br = (e, t, u = 1e-5) => e > t && !ae(e, t, u), _r = (e, t, u = 1e-5) => e < t || ae(e, t, u), wr = (e, t, u = 1e-5) => e > t || ae(e, t, u);
      var Ji = (e) => e.type === "number", Zi = (e) => typeof e == "number", Qi = (e) => typeof e == "string", ue = (e, t) => (u, r, n) => {
      ...
      }, EqualityExpr: ue((e, t, u) => ae(e, t, u.tolerance), (e, t) => e === t), LessThanExpr: ue((e, t, u) => Sr(e, t, u.tolerance), (e, t) => e < t), LessThanOrEqualExpr: ue((e, t, u) => _r(e, t, u.tolerance), (e, t) => e <= t), MoreThanExpr: ue((e, t, u) => br(e, t, u.tolerance), (e, t) => e > t), MoreThanOrEqualExpr: ue((e, t, u) => wr(e, t, u.tolerance), (e, t) => e >= t), BoolAnd_and: (e, t, u) => (r, n) => e.compile()(r, n) && u.compile()(r, n), BoolOr_or: (e, t, u) => (r, n) => e.compile()(r, n) || u.compile()(r, n), PriExp_paren: (e, t, u) => (r, n) => t.compile()(r, n), NonEqualityExpr: ue((e, t, u) => !ae(e, t, u.tolerance), (e, t) => e !== t), StartsWithExpr: ue((e, t, u) => false, (e, t) => e.startsWith(t)), EndsWithExpr: ue((e, t, u) => false, (e, t) => e.endsWith(t)) }, qt = (e, t) => {
      ...
      }, Ge = (e, t) => ({ type: "simple", value: typeof t == "function" ? t(e.sourceString) : e.sourceString }), Ve = { exactElement_ofCategory: (e, t) => ({ type: "exact-category", categories: [e.getPropertyDefinition().value] }), categoryOrProperty_inBrackets: (e, t, u) => Ge(t), categoryOrProperty_value: (e) => Ge(e), exactElement_ofPropertySequence: (e, t) => Lt(e), property_ofPropertySequence: (e, t, u) => qt(e, u), property_ofDirectAny: (e, t, u) => qt(e, u), property_ofDirectAnyPropertySequence: (e, t, u) => qt(e, u), directAnyProperty_ofCategory: (e, t, u) => ({ type: "exact-category", categories: [e.getPropertyDefinition().value, "*"] }), directAnyPropertySequence: (e, t, u) => Lt(e), directAnyProperty_sequenced: (e, t, u) => {
        let n = [...Lt(e).categories];
      ...
      }, directProperty_ofAnyProperty: (e, t, u) => ({ type: "exact-category", categories: ["*", u.getPropertyDefinition().value] }), number: (e) => ({ type: "number", value: parseFloat(e.sourceString) }), textConst: (e, t, u) => t.getPropertyDefinition(), startsWithConst: (e, t, u) => t.getPropertyDefinition(), endsWithConst: (e, t, u) => t.getPropertyDefinition(), textValue: (e) => Ge(e, (t) => t.replaceAll('\\"', '"')), likeTextValue: (e) => Ge(e, (t) => t.replaceAll('\\"', '"').replaceAll("\\%", "%")) }, Nr = { propertySequence: (e) => {
        let t = Or(e);
      ...
      var Ue = class {
        ...
        constructor() {
          this.semantics.addOperation("getPropertyDefinition", Ve), this.semantics.addOperation("getPropertyValue", Nr);
        }
      ...
      var We = class {
        ...
        settings;
        constructor(t) {
          this.settings = t || { tolerance: 1e-5, stringCaseSensitive: true }, this.semantics.addOperation("getPropertyDefinition", Ve), this.semantics.addOperation("compile", Pr);
        }
        createFilter(t) {
